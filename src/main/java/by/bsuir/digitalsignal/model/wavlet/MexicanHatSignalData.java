...
public class MexicanHatSignalData extends GraphSignalData {

    private final int N;
    private final int SDVIG = 0;

    public MexicanHatSignalData(GraphSignalData signalData, float fw, CommonData commonData) {
        super(commonData);
        ...
        this.N = Math.round(1.816F * this.frequencyResolution * this.sampleSize / fw);
        ...
        for (int i = 0; i < this.data.length; ++i) {
            ...
            this.data[i] = (float) ((1 - p * p) * Math.exp(-(p * p) / 2));
        }
    ...
    @Override
    public MexicanHatSignalData clone() throws CloneNotSupportedException {
        return (MexicanHatSignalData) super.clone();
    }
